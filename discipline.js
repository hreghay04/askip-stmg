...
const courseDiagrams = {
  cejm: [
    ...
    `<div class="course-diagram"><div class="diagram-label"><span>SCHÉMA DE SYNTHÈSE</span><b>La relation de travail</b></div><svg viewBox="0 0 700 310" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Structure de la relation de travail salarié"><rect x="225" y="10" width="250" height="60" rx="12" fill="#132b38"/><text x="350" y="40" text-anchor="middle" fill="#fff" font-weight="800" font-size="15" font-family="Manrope,sans-serif">CONTRAT DE TRAVAIL</text><text x="350" y="58" text-anchor="middle" fill="#b4c2c6" font-size="10" font-family="DM Sans,sans-serif">Prestation + Rémunération + Subordination</text><line x1="200" y1="70" x2="200" y2="110" stroke="#dfe2dc" stroke-width="2"/><line x1="350" y1="70" x2="350" y2="110" stroke="#dfe2dc" stroke-width="2"/><line x1="530" y1="70" x2="530" y2="110" stroke="#dfe2dc" stroke-width="2"/><rect x="110" y="110" width="180" height="80" rx="10" fill="#ef6a5b" opacity="0.1" stroke="#ef6a5b" stroke-width="1.5"/><text x="200" y="138" text-anchor="middle" fill="#ef6a5b" font-weight="800" font-size="12" font-family="Manrope,sans-serif">EMPLOYEUR</text><text x="200" y="156" text-anchor="middle" fill="#65747b" font-size="10" font-family="DM Sans,sans-serif">Pouvoir de direction</text><text x="200" y="172" text-anchor="middle" fill="#65747b" font-size="10" font-family="DM Sans,sans-serif">Contrôle et sanction</text><rect x="260" y="110" width="180" height="80" rx="10" fill="#5b8db8" opacity="0.1" stroke="#5b8db8" stroke-width="1.5"/><text x="350" y="138" text-anchor="middle" fill="#5b8db8" font-weight="800" font-size="12" font-family="Manrope,sans-serif">SALARIÉ</text><text x="350" y="156" text-anchor="middle" fill="#65747b" font-size="10" font-family="DM Sans,sans-serif">Prestation de travail</text><text x="350" y="172" text-anchor="middle" fill="#65747b" font-size="10" font-family="DM Sans,sans-serif">Droits et libertés</text><rect x="440" y="110" width="180" height="80" rx="10" fill="#e8b74f" opacity="0.12" stroke="#e8b74f" stroke-width="1.5"/><text x="530" y="138" text-anchor="middle" fill="#9a6c2a" font-weight="800" font-size="12" font-family="Manrope,sans-serif">SUBORDINATION</text><text x="530" y="156" text-anchor="middle" fill="#65747b" font-size="10" font-family="DM Sans,sans-serif">Ordres, contrôle,</text><text x="530" y="172" text-anchor="middle" fill="#65747b" font-size="10" font-family="DM Sans,sans-serif">sanctions = critère clé</text><rect x="60" y="220" width="175" height="70" rx="9" fill="#fff" stroke="#dfe2dc"/><text x="147" y="247" text-anchor="middle" fill="#132b38" font-weight="700" font-size="11" font-family="Manrope,sans-serif">CDI</text><text x="147" y="265" text-anchor="middle" fill="#65747b" font-size="10" font-family="DM Sans,sans-serif">Forme normale du contrat</text><rect x="265" y="220" width="175" height="70" rx="9" fill="#fff" stroke="#dfe2dc"/><text x="352" y="247" text-anchor="middle" fill="#132b38" font-weight="700" font-size="11" font-family="Manrope,sans-serif">CDD</text><text x="352" y="265" text-anchor="middle" fill="#65747b" font-size="10" font-family="DM Sans,sans-serif">Besoin temporaire uniquement</text><rect x="470" y="220" width="175" height="70" rx="9" fill="#fff" stroke="#dfe2dc"/><text x="557" y="247" text-anchor="middle" fill="#132b38" font-weight="700" font-size="11" font-family="Manrope,sans-serif">GPEC</text><text x="557" y="265" text-anchor="middle" fill="#65747b" font-size="10" font-family="DM Sans,sans-serif">Anticiper les besoins futurs</text></svg></div>`,
